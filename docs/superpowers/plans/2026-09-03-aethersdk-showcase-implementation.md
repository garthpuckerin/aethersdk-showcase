...
- Exported design: `C:\Users\garth\Downloads\Custom frontend design system.zip`; inspiration and component inventory, not product truth.
...
node --version
npm --version
Test-Path "C:\Users\garth\Downloads\Custom frontend design system.zip"
```
...
```powershell
tar -tf "C:\Users\garth\Downloads\Custom frontend design system.zip"
```
...
```powershell
Get-ChildItem "C:\Users\garth\Downloads" -File | Where-Object { $_.Name -match 'connex|architecture.map' } | Select-Object Name,Length,LastWriteTime
```
...
```text
D:\Garth P\portofolio-hub\BCSTANDARDS.md
D:\Garth P\portofolio-hub\docs\DEMO_POLISH_CHECKLIST.md
D:\Garth P\portofolio-hub\docs\REPO_RECONCILIATION_MAP.md
```
